...
HD_PWD='D:/University/ENTC sem 5/DSD/single/Final_project/RV32I_Processor_Design_SystemVerilog/Final_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV32I.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV32I.tcl -notrace
